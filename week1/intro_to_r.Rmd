...
arbuthnot <- arbuthnot %>%
  mutate(propotion_of_boys = boys / total)
ggplot(data = arbuthnot, aes(x = year, y = propotion_of_boys)) +
  geom_line() +
  geom_point()
```
...
ggplot(data = present, aes(x = year, y = prob_boys)) +
  geom_line() +
  geom_point()
```
